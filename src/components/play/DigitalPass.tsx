...
export const DigitalPass: React.FC<DigitalPassProps> = ({ booking, qrData }) => {
  ...
  return (
    <div className="max-w-sm mx-auto bg-[var(--play-surface)] rounded-2xl overflow-hidden shadow-xl border border-[var(--play-border)]">
      {/* Top Section */}
      <div className="bg-[var(--play-brand)] p-6 text-center relative overflow-hidden">
        {/* Decorative circles */}
        ...
        <h2 className="text-white text-xl font-bold tracking-tight mb-1 relative z-10">SPORTSVILLA</h2>
      ...
      <div className="flex justify-between items-center -mt-3 relative z-20">
        ...
        <div className="border-t-2 border-dashed border-gray-300 w-full mx-2" />
      ...
      <div className="p-8 pb-6 flex flex-col items-center border-b border-gray-100">
        <div className="text-xs text-[var(--play-text-muted)] uppercase tracking-widest font-semibold mb-4">
          Booking ID: <span className="text-[var(--play-text)]">{booking.id}</span>
        </div>
        
        <div className="bg-white p-3 rounded-xl shadow-sm border border-gray-100 min-h-[180px] flex items-center justify-center">
          {qrSrc ? (
      ...
      <div className="p-6 bg-gray-50/50">
        <div className="space-y-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <div className="text-xs text-[var(--play-text-muted)] font-medium">Sport</div>
              <div className="font-semibold text-[var(--play-text)]">{booking.sport}</div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <div className="text-xs text-[var(--play-text-muted)] font-medium">Venue</div>
              <div className="font-semibold text-[var(--play-text)]">{booking.venue}</div>
              {booking.turf && <div className="text-sm text-[var(--play-text-muted)] mt-0.5">{booking.turf}</div>}
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4 pt-2">
            <div className="flex items-start gap-2.5">
              ...
              <div>
                <div className="text-xs text-[var(--play-text-muted)] font-medium">Date</div>
                <div className="text-sm font-semibold text-[var(--play-text)]">{booking.date}</div>
              </div>
            </div>
            ...
            <div className="flex items-start gap-2.5">
              ...
              <div>
                <div className="text-xs text-[var(--play-text-muted)] font-medium">Time</div>
                <div className="text-sm font-semibold text-[var(--play-text)]">{booking.time}</div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-start gap-3 pt-2">
            ...
            <div>
              <div className="text-xs text-[var(--play-text-muted)] font-medium">Guest</div>
              <div className="font-semibold text-[var(--play-text)]">{booking.guestName}</div>
            </div>
          </div>
        </div>
      </div>
