...
export default function PhonePeClient({
  transactions,
  totalCount,
  totalSuccessValue,
  successRate,
  ...
  return (
    <div className="space-y-6 pb-20 font-sans">
      <PageHeader
        ...
        subtitle="Monitor PhonePe payment logs, verification status, and gateway identifiers."
        breadcrumbs={[
      ...
      <DataTable<TransactionRow>
        ...
        emptyMessage="No PhonePe transactions have been recorded yet."
        pagination={{
          page: currentPage,
          totalPages,
          totalItems: totalCount,
          onPageChange: (newPage) => {
            router.push(`/phonepe?page=${newPage}`);
          },
        }}
      />
    </div>
